...
$count_query = mysqli_query($conn, "SELECT COUNT(*) as total FROM kelas");
...
$kelas = mysqli_query($conn, "SELECT k.*, 
                              ...
                              FROM kelas k ORDER BY k.kode_kelas LIMIT $offset, $per_page");
?>
        ...
        <div class="col-md-9 col-lg-10">
            <div class="content-wrapper p-4">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mt-3 gap-2">
                    ...
                    <?= render_pagination($current_page, $total_pages, 'index.php?page=admin_kelas', []) ?>
                </div>
                <?php endif; ?>
            </div>
        </div>
