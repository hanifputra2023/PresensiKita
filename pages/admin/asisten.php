...
<style>
    ...
    .filter-bar-asisten .filter-group {
        flex: 1;
        min-width: 200px;
    }
    
    .filter-bar-asisten .filter-group-search {
        flex: 2;
        min-width: 280px;
    }
    
    .filter-bar-asisten .filter-group-action {
        flex: 0 0 auto;
        min-width: 120px;
    }
    
    .filter-bar-asisten .form-label-modern {
        display: flex;
        align-items: center;
        gap: 6px;
        font-size: 0.75rem;
    ...
    .filter-bar-asisten .form-label-modern i {
        font-size: 0.85rem;
        opacity: 0.7;
    }
    
    .filter-bar-asisten .search-input-wrapper {
        position: relative;
    }
    
    .filter-bar-asisten .search-icon {
        position: absolute;
        left: 16px;
        top: 50%;
    ...
    .filter-bar-asisten .search-input-wrapper:focus-within .search-icon {
        color: var(--primary-color);
    }
    
    .filter-bar-asisten .form-control-modern {
        width: 100%;
        border-radius: 12px;
    ...
    .filter-bar-asisten .form-control-modern::placeholder {
        color: var(--text-muted, #999);
        font-weight: 400;
    }
    
    .filter-bar-asisten .form-control-modern:hover {
        border-color: var(--primary-color);
    }
    
    .filter-bar-asisten .form-control-modern:focus {
        border-color: var(--primary-color);
        box-shadow: 0 0 0 4px rgba(0, 102, 204, 0.12);
        outline: none;
    }
    
    .filter-bar-asisten .btn-filter {
        display: inline-flex;
        align-items: center;
        justify-content: center;
        gap: 8px;
    ...
    .filter-bar-asisten .btn-filter:hover {
    ...
    .filter-bar-asisten .btn-filter.active {
        background: var(--primary-color);
        color: white;
    }
    
    .filter-bar-asisten .select-all-wrapper {
        display: flex;
        align-items: center;
        gap: 10px;
        padding: 14px 16px;
    ...
    .filter-bar-asisten .select-all-wrapper label {
        font-size: 14px;
        font-weight: 600;
        color: var(--primary-color);
        cursor: pointer;
    ...
    [data-theme="dark"] .filter-bar-asisten .form-control-modern {
        background: rgba(255, 255, 255, 0.05);
        border-color: rgba(255, 255, 255, 0.15);
    }
    
    [data-theme="dark"] .filter-bar-asisten .form-control-modern:hover,
    [data-theme="dark"] .filter-bar-asisten .form-control-modern:focus {
        border-color: var(--primary-color);
    }
    
    [data-theme="dark"] .filter-bar-asisten .select-all-wrapper {
    ...
    @media (max-width: 576px) {
        ...
        .filter-bar-asisten .action-buttons-mobile {
            display: flex;
            gap: 10px;
            width: 100%;
        }
        
        .filter-bar-asisten .action-buttons-mobile .btn-filter {
            flex: 1;
        }
    ...
    @media (min-width: 577px) and (max-width: 750px) {
        ...
        .welcome-banner-asisten > div {
            flex-direction: column !important;
            align-items: stretch !important;
            gap: 15px !important;
        }
        
        .welcome-banner-asisten > div > div:first-child {
            width: 100% !important;
        }
        ...
        .welcome-banner-asisten .btn.btn-banner {
            width: 100% !important;
        ...
        .welcome-banner-asisten .btn.btn-banner i {
            margin-right: 10px;
            font-size: 16px;
        }
                        ...
                        <div class="filter-row">
                            ...
                            <div class="filter-group filter-group-search">
                                ...
                                <div class="search-input-wrapper">
                                    ...
                                    <input type="text" name="search" id="searchInput" class="form-control-modern" value="<?= htmlspecialchars($search) ?>" placeholder="Ketik nama atau kode asisten...">
                                </div>
                            </div>
