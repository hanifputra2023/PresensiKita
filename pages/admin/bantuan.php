...
.welcome-banner-bantuan-admin::before {
    content: '';
    position: absolute;
    top: -50%;
    right: -50%;
...
.welcome-banner-bantuan-admin h1 {
    font-size: 32px;
    font-weight: 700;
    margin: 0;
    position: relative;
...
.welcome-banner-bantuan-admin .banner-subtitle {
    font-size: 16px;
    opacity: 0.95;
    position: relative;
    z-index: 1;
...
.welcome-banner-bantuan-admin .banner-icon {
    width: 60px;
    height: 60px;
...
.welcome-banner-bantuan-admin .banner-badge {
...
/* Dark Mode Support */
[data-theme="dark"] .welcome-banner-bantuan-admin {
    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10">
            <div class="content-wrapper p-4">
                <!-- Welcome Banner -->
                <div class="welcome-banner-bantuan-admin mb-4">
                        ...
                        <div>
                            <div class="d-flex align-items-center gap-3 mb-2">
                                ...
                                <div>
                                    ...
                                    <p class="banner-subtitle mb-0">Kelola tiket bantuan dan saran dari pengguna</p>
                                </div>
                            </div>
                            <span class="banner-badge">
                                <i class="fas fa-envelope-open-text me-1"></i>Pusat Bantuan
                            </span>
                        </div>
                    </div>
                </div>
