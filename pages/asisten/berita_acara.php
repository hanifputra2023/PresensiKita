...
<style>
    ...
    .welcome-banner-bap::before {
        ...
        animation: pulse-glow-bap 4s ease-in-out infinite;
    }
    
    @keyframes pulse-glow-bap {
        0%, 100% {
            transform: scale(1);
            opacity: 0.5;
        }
    ...
    .welcome-banner-bap .banner-subtitle {
        font-size: 16px;
        opacity: 0.95;
        position: relative;
        z-index: 1;
    ...
    .welcome-banner-bap .banner-badge {
    ...
    /* Dark Mode Support */
    [data-theme="dark"] .welcome-banner-bap {
    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10">
            <div class="content-wrapper p-4">
                <!-- Welcome Banner -->
                <div class="welcome-banner-bap mb-4">
