    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10">
            <div class="content-wrapper p-4">
                <!-- Welcome Banner -->
                <div class="welcome-banner-izin mb-4">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                        <div>
                            <div class="d-flex align-items-center gap-3 mb-2">
                                ...
                                <div>
                                    <h1 class="mb-1">Pengajuan Izin & Sakit</h1>
                                    <p class="banner-subtitle mb-0">Ajukan izin atau sakit dengan mudah dan lampirkan bukti jika diperlukan.</p>
                                </div>
                            </div>
                        </div>
                        <span class="banner-badge">
                            <i class="fas fa-file-alt me-1"></i>Formulir Pengajuan
                        </span>
                    </div>
                </div>
