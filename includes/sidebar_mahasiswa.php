...
<div class="sidebar d-flex flex-column p-3">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item">
            <a href="index.php?page=mahasiswa_dashboard" class="nav-link <?= is_active('mahasiswa_dashboard') ?>">
                <i class="fas fa-tachometer-alt"></i> Dashboard
            </a>
        </li>
        <li class="nav-item">
            <a href="index.php?page=mahasiswa_jadwal" class="nav-link <?= is_active('mahasiswa_jadwal') ?>">
                <i class="fas fa-calendar-alt"></i> Jadwal Praktikum
            </a>
        </li>
        <li class="nav-item">
            <a href="index.php?page=mahasiswa_scanner" class="nav-link <?= is_active('mahasiswa_scanner') ?>">
                <i class="fas fa-qrcode"></i> Scan QR Presensi
            </a>
        </li>
        <li class="nav-item">
            <a href="index.php?page=mahasiswa_riwayat" class="nav-link <?= is_active('mahasiswa_riwayat') ?>">
                <i class="fas fa-history"></i> Riwayat Presensi
            </a>
        </li>
        <li class="nav-item">
            <a href="index.php?page=mahasiswa_izin" class="nav-link <?= is_active('mahasiswa_izin') ?>">
                <i class="fas fa-envelope"></i> Pengajuan Izin
            </a>
        </li>
        <li class="nav-item">
            <a href="index.php?page=mahasiswa_inhall" class="nav-link <?= is_active('mahasiswa_inhall') ?>">
                <i class="fas fa-redo"></i> Inhall
            </a>
        </li>
        <li class="nav-item">
            <a href="index.php?page=mahasiswa_profil" class="nav-link <?= is_active('mahasiswa_profil') ?>">
    ...
    <div class="dropdown d-none d-md-block">
        ...
        <ul class="dropdown-menu dropdown-menu-dark text-small shadow">
            <li><span class="dropdown-item-text text-muted"><?= sapaan_waktu() ?>, Mahasiswa</span></li>
